...
)  # Chamando a função com múltiplos argumentos de palavra-chave arbitrários
...
exemplo_completo(
    1, 3, 4, 5, nome="Alice", idade=30
)  # Chamando a função com todos os tipos de argumentos
...
numeros(
    1, b=2, c=3
)  # Chamando a função com um argumento posicional e dois argumentos nomeados
...
soma(
    1, 2
)  # Chamando a função com dois argumentos, usando o valor padrão para o terceiro
...
print(
    f"A soma é {soma3(1)}"
)  # Chamando a função com um argumento, usando os valores padrão para os outros
print(
    f"A soma é {soma3(1, 2)}"
)  # Chamando a função com dois argumentos, usando o valor padrão para o terceiro
print(
    f"A soma é {soma3(1, z=2, y=3)}"
)  # Chamando a função com três argumentos, usando a ordem nomeada para os parâmetros
