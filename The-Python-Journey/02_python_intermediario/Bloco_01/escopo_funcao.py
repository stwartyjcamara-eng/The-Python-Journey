...
def funcao2():
    ...
    print(f"Valor de x dentro da função: {int(x)}") # Converte a variável local x para inteiro e imprime
...
def escopo():
    ...
    def escopo_interno():
        ...
        print(f"Valor de x dentro da função escopo_interno: {x}")  # Acessa a variável x do escopo externo
        print(f"Valor de y dentro da função escopo_interno: {y}")  # Acessa a variável y do escopo interno
        def escopo_interno2():
...
def escopo_global():
    ...
    print(f"Valor de x dentro da função escopo_global: {x}")  # Acessa a variável global x
    def escopo_local():
        ...
        print(f"Valor de x dentro da função escopo_local: {x}")  # Acessa a variável local x
